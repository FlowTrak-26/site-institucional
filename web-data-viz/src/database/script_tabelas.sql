...
CREATE TABLE empresa_parceira(
	...
	telefone CHAR(11),
	franqueadora INT,
	CONSTRAINT ctFkFranqueadora
	FOREIGN KEY(franqueadora)
	REFERENCES empresa_parceira(id_empresa)
);
...
CREATE TABLE usuario(
	...
	CONSTRAINT ctFkEmpresaParceira
	FOREIGN KEY(fk_empresa_parceira)
	REFERENCES empresa_parceira(id_empresa),
	CONSTRAINT ctNivelAcesso
	CHECK (nivel_acesso IN ('ADMIN','COMUM'))
);
...
CREATE TABLE sensor(
	...
	nome VARCHAR(45),
	status VARCHAR(45),
	CONSTRAINT ctFkPontoMonitoramento
	FOREIGN KEY (fk_ponto)
	REFERENCES ponto_monitoramento(id_ponto_monitoramento),
	CONSTRAINT ctStatus
...
VALUES
	...
	'contato@supermercadosbh.com', '11999990003', NULL),
	('Assaí Atacadista', '06057223000171', 'Av. Aricanduva, 5555',
	'contato@assai.com', '11999990004', NULL),
	('Muffato', '01648512000108', 'Rod. Celso Garcia Cid, 1100',
	'contato@muffato.com', '11999990005', NULL);
...
-- tirar isso
INSERT INTO dado_captado (fk_sensor, data_hora, fluxo)
VALUES
    (1, '2026-06-08 08:00:00', 1),
    (1, '2026-06-08 08:05:00', 1),
    (1, '2026-06-08 08:10:00', 1),
    (2, '2026-06-08 08:00:00', 1),
    (3, '2026-06-08 08:00:00', 1),
    (3, '2026-06-08 08:05:00', 1),
    (3, '2026-06-08 08:10:00', 1),
    (3, '2026-06-08 08:15:00', 1),
    (3, '2026-06-08 08:20:00', 1),
    (4, '2026-06-08 08:00:00', 1),
    (4, '2026-06-08 08:05:00', 1),
    (5, '2026-06-08 08:00:00', 1),
    (6, '2026-06-08 08:00:00', 1),
    (6, '2026-06-08 08:05:00', 1),
    (6, '2026-06-08 08:10:00', 1),
    (6, '2026-06-08 08:15:00', 1);
...
INSERT INTO dado_captado (data_hora, fluxo, fk_sensor)
VALUES
...
SELECT
	...
	e.nome
FROM sensor AS s
JOIN ponto_monitoramento AS p
ON s.fk_ponto = p.id_ponto_monitoramento
JOIN empresa_parceira AS e
ON e.id_empresa = p.fk_empresa;
...
ON dc.fk_sensor = s.id_sensor
WHERE dc.data_hora
BETWEEN '2023-10-27 08:00:00'
AND '2023-10-27 09:30:00';


CREATE VIEW dashGraficosLinha AS
SELECT
	emp.id_empresa AS id_empresa,
	emp.franqueadora AS id_franqueadora,
